...
//
/// ** Author oldlu Desc 模拟双11商品实时交易大屏统计分析 */
...
//    // 3.transformation
//    // .keyBy(0)
//    SingleOutputStreamOperator<CategoryPojo> tempAggResult =
//        sourceDS
//            .keyBy(0)
...
//    tempAggResult
//        .keyBy("dateTime") // 按照时间分组是因为需要每1s更新截至到当前时间的销售总额
//        // 每秒钟更新一次统计结果
...
//
//  /**
//   * 自定义价格聚合函数,其实就是对price的简单sum操作 AggregateFunction<IN, ACC, OUT> AggregateFunction<Tuple2<String,
...
//
//  /**
//   * 自定义WindowFunction,实现如何收集窗口结果数据 interface WindowFunction<IN, OUT, KEY, W extends Window>
...
//    @Override
//    public void apply(
//        Tuple tuple, TimeWindow window, Iterable<Double> input, Collector<CategoryPojo> out)
//        throws Exception {
...
//
//  /**
//   * 实现ProcessWindowFunction abstract class ProcessWindowFunction<IN, OUT, KEY, W extends Window>
//   * abstract class ProcessWindowFunction<CategoryPojo, Object, Tuple就是String类型的dateTime,
// TimeWindow
//   * extends Window>
//   *
//   * <p>把各个分类的总价加起来，就是全站的总销量金额， 然后我们同时使用优先级队列计算出分类销售的Top3，
